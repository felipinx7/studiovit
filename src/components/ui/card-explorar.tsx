...
export function CardExplorar(props: InterfaceCardSolucao) {
  return (
    <article data-aos={props.direcao ? 'fade-left' : 'fade-right'}  >
      <div className="flex h-[280px] w-full flex-col items-center justify-between rounded-[1.1rem] bg-white p-4 shadow-[0px_0px_6px_0px_rgba(255,190,46,0.10)] duration-500 ease-in-out hover:scale-105 md:h-[300px] md:p-7">
