...
export function CardFaq(props: interfacePerguntasFrequente) {
  ...
  return (
    <article  className="bg-zinc-100/80 flex w-[80%] flex-col rounded-tl-[20px] rounded-tr-[20px] rounded-br-[20px] px-4 py-3 transition-[max-height,opacity,transform] duration-500 ease-in-out max-md:h-auto max-md:w-[90%]" data-aos={props.direcao ? 'fade-left' : 'fade-right'}>
      <div>
