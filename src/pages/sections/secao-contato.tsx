    ...
    >
      <div className="mt-0 flex w-[100%] max-w-[1280px] flex-col items-center justify-start gap-8">
        ...
        >
          ...
          <button className="text-neutral-0 from-primary-100/0 hover:bg-primary-700 flex w-[40%] items-center justify-center gap-3 rounded-2xl border-2 border-amber-400 bg-gradient-to-r to-amber-500/0 p-6 text-2xl font-medium shadow-md transition-all duration-500 hover:scale-105 hover:border-black max-md:w-[80%]">
            <a
